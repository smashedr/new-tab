...
[![GitHub Downloads](https://img.shields.io/github/downloads/cssnr/new-tab/total?logo=github)](https://github.com/cssnr/new-tab/releases)
...
[![GitHub Repo Size](https://img.shields.io/github/repo-size/cssnr/new-tab?logo=buffer&label=repo%20size)](https://github.com/cssnr/new-tab?tab=readme-ov-file#readme)
[![GitHub Top Language](https://img.shields.io/github/languages/top/cssnr/new-tab?logo=devbox)](https://github.com/cssnr/new-tab?tab=readme-ov-file#readme)
[![GitHub Contributors](https://img.shields.io/github/contributors-anon/cssnr/new-tab?logo=southwestairlines)](https://github.com/cssnr/new-tab/graphs/contributors)
[![GitHub Issues](https://img.shields.io/github/issues/cssnr/new-tab?logo=codeforces&logoColor=white)](https://github.com/cssnr/new-tab/issues)
[![GitHub Discussions](https://img.shields.io/github/discussions/cssnr/new-tab?logo=theconversation)](https://github.com/cssnr/new-tab/discussions)
[![GitHub Forks](https://img.shields.io/github/forks/cssnr/new-tab?style=flat&logo=forgejo&logoColor=white)](https://github.com/cssnr/new-tab/forks)
[![GitHub Repo Stars](https://img.shields.io/github/stars/cssnr/new-tab?style=flat&logo=gleam&logoColor=white)](https://github.com/cssnr/new-tab/stargazers)
...
<a title="New Tab" href="https://github.com/cssnr/new-tab?tab=readme-ov-file#readme" target="_blank">
<img alt="New Tab" align="right" width="128" height="auto" src="https://raw.githubusercontent.com/cssnr/new-tab/master/src/assets/icon.svg"></a>
...
[![Firefox](https://raw.githubusercontent.com/smashedr/logo-icons/master/browsers/firefox_48.png)](https://github.com/cssnr/new-tab/releases/latest/download/new-tab-firefox.xpi)
...
- Download a [Chrome Release](https://github.com/cssnr/new-tab/releases/latest/download/new-tab-chrome.crx) from GitHub
- Download a [Firefox Release](https://github.com/cssnr/new-tab/releases/latest/download/new-tab-firefox.xpi) from GitHub
...
> Submit a [Feature Request](https://github.com/cssnr/new-tab/issues/new?template=1-feature.yaml).
...
- Report an Issue: <https://github.com/cssnr/new-tab/issues>
- Q&A Discussion: <https://github.com/cssnr/new-tab/discussions/categories/q-a>
- Request a Feature: <https://github.com/cssnr/new-tab/issues/new?template=1-feature.yaml>
- Chat with us on Discord: <https://discord.gg/wXy6m2X8wY>

[![Features](https://img.shields.io/badge/features-brightgreen?style=for-the-badge&logo=rocket&logoColor=white)](https://github.com/cssnr/new-tab/issues/new?template=1-feature.yaml)
[![Issues](https://img.shields.io/badge/issues-red?style=for-the-badge&logo=southwestairlines&logoColor=white)](https://github.com/cssnr/new-tab/issues)
[![Discussions](https://img.shields.io/badge/discussions-blue?style=for-the-badge&logo=livechat&logoColor=white)](https://github.com/cssnr/new-tab/discussions)
...
Additionally, you can star this project on [GitHub](https://github.com/cssnr/new-tab).
...
<a href="https://github.com/cssnr/new-tab/stargazers">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=cssnr/new-tab&type=date&legend=bottom-right&theme=dark" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=cssnr/new-tab&type=date&legend=bottom-right" />
   <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=cssnr/new-tab&type=date&legend=bottom-right" />
 </picture>
</a>
